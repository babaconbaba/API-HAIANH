...
\`\`\``,
          properties: {
            ...
            PostToGL: { type: 'boolean', default: false, description: 'Ghi sổ cái (GL) khi tạo? **false** (mặc định) = chỉ lưu chứng từ, MISA hiện màu xanh, kế toán review rồi ghi sổ sau. **true** = ghi sổ GL + IsPostedFinance=true luôn.' },
