...
\`\`\``,
          properties: {
            ...
            PostToGL: { type: 'boolean', default: true, description: 'Ghi sổ cái (GL) luôn khi tạo? **false** = chỉ lưu chứng từ, kế toán review rồi ghi sổ sau trên MISA desktop (hiện màu xanh). **true** (mặc định) = ghi sổ GL + IsPostedFinance=true luôn.' },
